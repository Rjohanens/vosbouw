<div {{ $attributes->merge(['class' => ' group flex aspect-square bg-gray-100 hover:scale-105 hover:bg-orange-500 hover:text-white ransition duration-300 cursor-pointer']) }}>
