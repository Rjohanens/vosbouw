<div class="grid gird-cols-1 lg:grid-cols-4  bg-dark px-16 py-24 mt-24">
        ...
        <div class="flex flex-col text-white w-3/5">
            ...
            <div class="flex flex-col space-y-2 mt-4">
                <div class="flex flex-row items-center gap-x-4">
                    ...
                    <span class="text-white text-sm font-light">Nieuweweg 92, 9649 AG Muntendam</span>
                </div>
                <div class="flex flex-row items-center gap-x-4">
                    ...
                    <span class="text-white text-sm font-light">+ 31(0) 6 203 213 30</span>
                </div>
                <div class="flex flex-row items-center gap-x-4">
                ...
                <div class="flex flex-row items-center gap-x-4">
                    ...
                    <a class="text-white text-sm font-light" href="mailto:info@mail.vosbouwnoord.nl">info@mail.vosbouwnoord.nl</a>
                </div>
            </div>
        </div>
