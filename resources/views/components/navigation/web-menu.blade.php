 <nav class="flex w-full items-center justify-between px-6 py-4 lg:px-8">
    <div class="flex lg:flex-1 z-50">
     ...
     <div class="flex lg:hidden">
      <button x-cloak x-show="!mobile" x-on:click="mobile = true" type="button" class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-white">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6">
          <path d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      </button>
       <button x-cloak x-show="mobile" x-on:click="mobile = false" type="button" command="close" commandfor="mobile-menu" class="-m-2.5 rounded-md p-2.5 text-navbar-foreground">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6">
