            ...
            <div class="inline-block min-w-full py-2 align-start sm:px-6 lg:px-8">
                <table class="min-w-full divide-y divide-gray-300">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-medium text-gray-900">Plaats</th>
                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-medium text-gray-900">Type</th>
                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-medium text-gray-900">Status</th>
                        <th scope="col" class="px-3 py-3.5 text-center text-sm font-medium text-gray-900">Zichtbaar op home</th>
                    </tr>
                    </thead>
