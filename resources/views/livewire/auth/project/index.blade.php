    ...
    @section('content')
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            <div class="sm:flex-auto">
                <h1 class="text-base font-semibold leading-6 text-gray-900">Projecten</h1>
                <p class="mt-2 text-sm text-gray-700">Creeër, bewerk en verwijder projecten</p>
            </div>
            <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                <button type="button" class="flex items-center space-x-2 rounded-md bg-orange-500 px-3 py-2 text-center text-sm font-lighth text-white shadow-sm hover:bg-orange400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-500">
