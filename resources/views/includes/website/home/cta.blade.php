<div class="grid grid-cols-2 gap-x-16 px-16 py-32">
    <div class="flex flex-col">
        ...
        <div class="grid grid-cols-2 gap-x-4 max-w-lg w-full mt-16">
            <div class="flex flex-col w-full rounded-lg space-y-2 p-4 bg-secondary">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="font-light text-zinc-700 text-sm">Nieuweweg 92, 9649 AG Muntendam</span>
                </div>
                <div class="flex items-center space-x-2">
                    ...
                    <span class="font-light text-zinc-700 text-sm">+ 31(0) 6 203 213 30</span>
                </div>
                <div class="flex items-center space-x-2">
