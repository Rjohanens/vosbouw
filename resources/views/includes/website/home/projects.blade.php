...
<div class="flex justify-center w-full">
    <a href="{{ route('project.index') }}" class="w-fit px-4 py-3 text-sm font-medium border border-zinc-400 shadow-sm hover:bg-orange-500 hover:border-orange-500 hover:text-white transition duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600">
