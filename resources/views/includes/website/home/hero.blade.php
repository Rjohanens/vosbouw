 <div class="relative isolate overflow-hidden pt-14 bg-background">
    <div class="mx-auto max-w-7xl px-6 py-24 sm:py-40 lg:px-8">
      <div class="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-8 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
        <h1 class="text-foreground w-full md:max-w-2xl text-balance text-5xl font-normal md:tracking-tight text-dark sm:text-7xl lg:col-span-2 xl:col-auto dark:text-white">
            Uw bouwpartner in de regio.
        </h1>
        <div class="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
          <p class="text-muted-foreground text-pretty text-base font-light text-dark/70 sm:text-xl/8">
          ...
          <div class="mt-10 grid grid-cols-1 md:flex items-center gap-2 lg:gap-x-4">
            <x-inputs.button variant="primary" label="Neem contact op" href="{{ route('contact.index') }}" />
            <x-inputs.button variant="outline" label="Diensten →" href="#contact" />
          </div>
        </div>
